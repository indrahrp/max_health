...
<h2>A life with this condition — Stories</h2>
...
<p><strong>Diana, 28.</strong> Her lupus came for her joints first — both wrists, both ankles. She was told it was probably viral arthritis and given anti-inflammatories. Six weeks later she developed pleuritis and her GP finally ordered an ANA panel. It came back at 1:2560. She had never had the butterfly rash. She had been told she was "too young" for a serious connective tissue disease. Her rheumatologist told her that was a common reason lupus goes undetected in young women: the textbook rash is only present in about half of cases, and without it, the diagnosis is easily missed.</p>
<p><strong>Jerome, 45.</strong> He was referred to rheumatology after his fourth episode of unexplained pericarditis — inflammation of the sac around the heart. Each episode had been treated as idiopathic. Nobody had connected them. The autoimmune workup found anti-Smith antibodies, highly specific for lupus. He had been having pericarditis attacks for seven years. The disease had been visible every time, in the one organ no one had thought to connect to an immune condition.</p>
<p><strong>Camille, 19.</strong> She was in her first year of university when fatigue became so total she could not get from her dormitory bed to lectures. She slept twelve hours and woke unrefreshed. Her joints ached. Her hair came out in clumps in the shower. She was investigated for anaemia, thyroid disease, and depression before haematology found haemolytic anaemia. The ANA was positive; the anti-dsDNA confirmed lupus. The fatigue pathologised as anxiety was her immune system running at full activation against her own red blood cells and nuclear proteins simultaneously.</p>
<p><strong>Transcript witness — Dr. Anthony Chaffee podcast.</strong> A clinician who works with fibromyalgia and lupus patients: "The pain is astronomical, if I am being real. I have had a lot of success in helping people do much better with lupus on a meat-based approach. What I notice is that the pain starts to shift within the first few weeks, and then over months, the antibody picture begins to change. I have seen anti-dsDNA titres fall. I have seen complement come back up. I was taught this was not possible."</p>
<p><strong>Renata, 33.</strong> Her first rheumatologist told her she had fibromyalgia and offered antidepressants. Her second rheumatologist, three years later, ordered an anti-Smith antibody panel after noticing her ANA titre had been sitting at 1:160 in records from multiple previous visits that no one had followed up. The anti-Smith came back positive. She had been managing a mis-labelled disease for three years, adjusting her life around pain that everyone around her was effectively telling her was not real.</p>
<p><strong>Yuki, 41.</strong> Her lupus went into remission on her own — rare, but documented — and she came off hydroxychloroquine after five years. Two years later it returned, triggered by the combination of a viral illness and a period of significant psychological stress. Her rheumatologist restarted medication and noted that while the trigger was the infection, the vulnerability was still there. Remission in lupus is conditional, not cured. She had learned that during the years of remission she had begun to treat herself as healthy in a way that was not entirely accurate.</p>
''',
})
...
<p><strong>Simone, 36.</strong> Her MS diagnosis came only after she pushed back on a psychiatry referral. She had double vision and left-sided numbness; her first neurologist attributed both to stress and anxiety. She came prepared to her second appointment with a printed list of her symptoms, their timings, and the Lhermitte's sign she had looked up herself — an electric shock sensation down her spine when she flexed her neck. An MRI the same week showed seven lesions. She had been right. The cost of the three-month delay between appointments was one relapse.</p>
<p><strong>Transcript witness — Dr. Anthony Chaffee podcast.</strong> A practitioner who has documented MS patients improving on carnivore: "I have a patient — not a patient of mine, but someone I have discussed for our case series — who is reversing multiple sclerosis on an animal-based diet. When you remove the things that are causing the damage, the body is very good at repairing itself. Myelin can remyelinate. It is not fast, but it happens. The key insight from the Epstein-Barr research is that MS is probably not a disease of the nervous system generating its own attack — it is the immune system responding to a viral trigger that it cannot resolve."</p>
<p><strong>Kieran, 29.</strong> He was a professional cyclist when his first relapse took his right leg's coordination. He spent two months in physiotherapy recovering what the demyelination had taken. He returned to racing; his neurologist put him on a disease-modifying drug that reduced relapse rate but produced fatigue that made competitive racing impossible. He retired from professional sport not because of the MS directly but because the medication required to control it took away what the disease had not. He described the trade-off as "choosing which kind of loss to live with."</p>
<p><strong>Beatriz, 52.</strong> She had been in clinical remission on natalizumab for six years when her neurologist raised the concern of PML — a rare but often fatal brain infection that becomes a risk after extended natalizumab use in JC virus-positive patients. She tested positive for JC antibodies and needed to switch medication. The switch triggered a rebound inflammatory activity that produced her worst relapse in a decade. Her neurologist had warned her this could happen; knowing it was possible had not prepared her for the reality of losing two weeks of mobility while her new drug established effect.</p>
<p><strong>Anthony, 44.</strong> His transition from relapsing-remitting to secondary progressive MS happened without a distinct moment — just a gradual understanding, over eighteen months of monitoring MRI scans that showed no new lesions but a slow, steady loss of walking distance, that the character of his disease had changed. His neurologist explained the distinction: in the relapsing phase, relapses are the main driver of disability; in progressive disease, it is slow neurodegeneration that continues independently of inflammation. The drugs that had worked before were now addressing the wrong mechanism. Treatment needed to change.</p>
''',
})
...
<p><strong>Transcript witness — Dr. Anthony Chaffee podcast.</strong> A woman speaker describing her RA reversal: "I was an artist. I developed 28 nodules in my right hand within a month — a contracture of the hand called Dupuytren's — and while I was being treated for it, I was diagnosed with rheumatoid arthritis. Thirteen years later, all the nodules have disappeared. I have full use of my hand. When I found out about carnivore I thought it was absolutely insane. But there were randomised controlled trials. There were people like me who had gotten better. And now I am one of them."</p>
<p><strong>McKayla Peterson — referenced on the Anthony Chaffee podcast.</strong> McKayla Peterson suffered with severe rheumatoid arthritis as a child, underwent two major joint surgeries, and later described achieving remission through a strict elimination diet. Her story drew significant attention to the possibility of dietary disease modification in RA — a possibility her rheumatologists had not raised as an option. Her father, Jordan Peterson, independently adopted a similar dietary approach for his own health conditions and reported comparable improvements.</p>
<p><strong>Daria, 47.</strong> Her RA went into remission on methotrexate after two years, and she and her rheumatologist agreed to trial a slow taper. She tapered successfully to a lower dose and then — over her rheumatologist's caution — to zero, feeling well for eight months before her DAS28 score crept upward again at her routine check. She restarted methotrexate. Her rheumatologist told her that drug-free remission in RA is achievable but fragile, more likely in patients who are seronegative. Daria was strongly seropositive. The disease had not gone away; it had been suppressed, and it knew when the suppression lifted.</p>
<p><strong>Victor, 63.</strong> He had RA for twenty-two years and remembered the exact moment the disease had decided to show him what it was capable of: a cervical spine subluxation requiring emergency stabilisation surgery. Longstanding RA erodes the ligaments of the upper cervical spine; his neurologist told him it was the most feared extra-articular complication of the disease. He had managed his joint disease well. He had not known to ask about his spine. Routine cervical screening in RA of his duration was now standard; it had not been when he was diagnosed.</p>
<p><strong>Anya, 39.</strong> She had heard about a strict carnivore elimination diet from a friend and tried it without telling her rheumatologist, expecting it to make no difference. After three months her morning stiffness was gone. After six months her CRP was normal for the first time in four years. She told her rheumatologist, who was sceptical but reviewed her results. Her DAS28 score — a composite of joint tenderness, swelling, and inflammatory markers — had fallen from 5.1 to 2.3. Her rheumatologist said she had achieved low disease activity. She asked what had caused it. Her rheumatologist said they could not be sure. She was sure.</p>
''',
})
...
<p><strong>Transcript witness — Dr. Anthony Chaffee podcast.</strong> A physician describing randomised controlled trial evidence: "There are studies going back to 1984, 1985, 1987 showing that removing carbohydrates and fibre can put Crohn's disease into remission for up to 51 months without medication. The control group that did not remove carbohydrates and fibre could not even stay in remission. Why is this not taught in gastroenterology training? Why does a person with Crohn's have to find this on their own? These are not fringe findings. They are published, randomised, controlled trials."</p>
<p><strong>Tomas, 27.</strong> He had Crohn's that responded initially to azathioprine and then stopped responding. His gastroenterologist moved him to a biologic and he had three good years before developing antibodies to that drug too. This was the pattern his gastroenterologist described as "step therapy" — each medication working for a period, then failing. He asked at each step what he could do with his diet. At each step he was told diet would not make a significant difference. It was only when he looked outside his hospital that he found people who had stopped the step therapy at step one by removing the foods that appeared to drive his inflammation.</p>
<p><strong>Ingrid, 35.</strong> Her Crohn's fistula had been repaired surgically and was holding. Her gastroenterologist was pleased with her imaging. What he could not see was that Ingrid had quietly eliminated all grains, legumes, and processed foods from her diet six months earlier after reading about a clinical case series from Hungary. Her CRP — previously elevated at 48 — was now 3. She did not volunteer this information at her appointments for nearly a year, afraid she would be told to stop. When she finally told her gastroenterologist, he reviewed her bloods, reviewed her imaging, and said: "Whatever you are doing, keep doing it."</p>
<p><strong>Kwame, 21.</strong> He was diagnosed during his university entrance exams. The timing meant that alongside learning he had a chronic disease, he was making decisions about university courses around proximity to hospitals, the likelihood of surgery, the feasibility of gap years. He eventually chose a university near a specialist IBD unit and deferred his start by a year. His gastroenterologist told him that with good management, Crohn's need not define his career. What the gastroenterologist did not mention was what "good management" had historically meant for people like Kwame — and what it was beginning to mean now.</p>
''',
})
...
<p><strong>Transcript witness — Dr. Anthony Chaffee podcast.</strong> A gastric surgeon describing his moment of realisation: "I can remember the moment I learned that autoimmune diseases are actually reversible. I said, 'Wild. Why? Why did nobody tell me that? How come I don't know that? How come you go to the textbook and it doesn't have anything that is cure?' I cut out people's colons because their ulcerative colitis had boring big holes and ulcers in it. They died. And you're telling me if I would have changed the freaking menu? That's the answer. That is a guilt I will hold for the rest of my life."</p>
<p><strong>Hannah, 34.</strong> She had been hospitalised twice with toxic megacolon — the rare, life-threatening complication of severe UC where the colon loses its muscle tone and balloons. Twice she had been within hours of a colectomy, and twice IV ciclosporin had pulled her back from surgery. Her gastroenterologist told her that a third episode would almost certainly end with surgery. She started an exclusion diet between hospitalisations, not from confidence but from the understanding that the trajectory she was on had a clear destination, and she needed to try something different before she arrived there.</p>
<p><strong>Patrick, 51.</strong> His UC had been in remission for eight years when he retired and found, within three months, that the stress reduction of retirement coincided with the best bloods he had recorded in a decade. His gastroenterologist noted that psychosocial stress is a consistent flare trigger in UC through HPA axis activation of intestinal mast cells. Patrick had been managing his disease well on medication. He had not known that his job had been managing it badly in parallel. The retirement was the dietary and lifestyle intervention his disease had been waiting for.</p>
<p><strong>Zara, 26.</strong> She was vegetarian and her gastroenterologist supported this, emphasising the importance of fibre for gut health. She had four flares in eighteen months. She eventually tried — against everything she had been told — removing fibre from her diet. The flare she was in at the time resolved within two weeks. Her calprotectin, which had been over 2000, dropped below 100 within three months. She came back to her gastroenterologist with the results. He reviewed them in silence. He said: "This is not what the guidelines say. But those are your numbers."</p>
''',
})
...
<p><strong>Transcript witness — Dr. Anthony Chaffee podcast.</strong> A trainer who coached an Olympic T1D athlete: "In my mid-40s I was lucky to train an athlete who had type 1 diabetes. She knew T1D better than anyone I had ever been trained about. She did not follow the guidelines. She did what she thought was best for her, which was keeping carbohydrate essentially at zero. We got her to the Olympics. Her glucose control was the best I had seen in any athlete, diabetic or not. It was only afterward that I started to understand that she had not been ignoring the guidelines out of stubbornness — she had discovered something those guidelines had not caught up with yet."</p>
<p><strong>Isobel, 22.</strong> She was the third person in her family with T1D — her mother, her brother, and now her. Her endocrinologist told her that the genetic predisposition meant her immune priming had probably begun in childhood; the only question had been which environmental trigger would tip her over the threshold. She had always been told by relatives that T1D was "just genetics." She was beginning to understand that genetics loaded the gun and something else pulled the trigger, and that the identity of that something else mattered for every other decision she would now make about her health.</p>
<p><strong>Marcus, 38.</strong> He had managed his T1D for 24 years when he switched from a multiple daily injection regimen to a closed-loop system — an algorithm linking a continuous glucose monitor to an insulin pump that adjusted delivery automatically. The first morning he woke to a glucose of 5.2 after an overnight run with no intervention on his part, he sat in bed for a long time. He had spent 24 years waking up and immediately calculating. He understood for the first time what people without diabetes experienced as a baseline. He had not known, before that moment, how much cognitive load diabetes had taken from him every single day.</p>
<p><strong>Sofia, 7 — her mother Elena, 35, speaking.</strong> "Sofia went into DKA three days before her seventh birthday. She had been sick for weeks and I had taken her to the GP twice. Both times I was told it was a virus. On the third visit I drove straight to the emergency department. Her glucose was 41. We were told she had type 1 diabetes and that she would need insulin for the rest of her life. We were told to go home and wait for a diabetes nurse appointment. We sat in the car park for two hours. She is now nine, she manages her pump herself, she checks her levels at school, and she has never missed a birthday cake. But I have not stopped thinking about those three weeks."</p>
''',
})
...
<p><strong>Transcript witness — Dr. Anthony Chaffee podcast.</strong> A practitioner with over 100 Hashimoto's patients: "I see so many people who are hypothyroid and I have over 100 patients with Hashimoto's. Not even getting into the whole estrogen side of things — there are so many reasons why a carnivore diet improves thyroid function. Hashimoto's is the most common autoimmune condition I treat, and it is one of the most responsive to dietary intervention. I have seen anti-TPO titres fall from the hundreds to within normal range. I have seen patients come off levothyroxine. I was not taught that was possible. I am seeing it anyway."</p>
<p><strong>Nadia, 29.</strong> Her Hashimoto's was found incidentally when her GP ordered a thyroid panel as part of a general fatigue workup. Her TSH was mildly elevated at 6.2; her anti-TPO was 380. She had no symptoms she had thought to mention — the fatigue was "just life," the cold was "just how she was," the dry skin was "just winter." Her GP told her she might not need medication yet, but to monitor. She started monitoring and discovered that with each check over two years her TSH climbed — 7.4, then 9.1 — and her symptoms she had normalised became ones she could not. She started levothyroxine on the third check and felt, for the first time in years, like herself.</p>
<p><strong>Olga, 44.</strong> She removed gluten from her diet after reading a randomised trial showing anti-TPO titres falling significantly in Hashimoto's patients on a gluten-free diet — without coeliac disease being present. Her gastroenterologist had told her the trial was too small. Her endocrinologist had said the evidence was insufficient to recommend. She removed it anyway. Her anti-TPO dropped from 520 to 180 over eight months. She brought the results to her endocrinologist, who said they were "encouraging." She asked whether she should put gluten back to confirm causality. He said that was her decision. She did not put it back.</p>
<p><strong>Freya, 55.</strong> She had been on levothyroxine for sixteen years and felt adequately managed — until she discovered that "adequately managed" had a different meaning to her endocrinologist than to her. Her TSH was in range, which her endocrinologist considered the goal. She had persistent fatigue, persistent brain fog, and persistent weight gain that did not resolve on the medication. A functional medicine doctor ordered T3 alongside TSH and found her free T3 was in the low normal range despite normal TSH. She added liothyronine. The brain fog lifted within three weeks. She had been in range. She had not been well.</p>
''',
})
...
<p><strong>Transcript witness — Dr. Anthony Chaffee podcast.</strong> On the mechanism of Graves' and dietary intervention: "If the lectins or food-derived antigens are triggering the antibody response that stimulates the TSH receptor, then when you remove those triggers, over time those antibodies will come down. I have seen that with Hashimoto's and Graves'. With Graves', the symptoms — the palpitations, the tremor, the heat intolerance — start to ease before the antibody titres formally normalise. People often feel better and think they have recovered. The titres catch up later. The sequence matters: symptoms first, then antibodies, in that order."</p>
<p><strong>Mei, 27.</strong> She was hyperthyroid throughout her pregnancy and her obstetrician and endocrinologist managed her carefully with low-dose propylthiouracil, which crosses the placenta less than carbimazole. Her baby was born at term, healthy, with normal thyroid function. What her endocrinologist told her afterward was that pregnancy often temporarily improves Graves' disease through the immune tolerance mechanisms that protect the fetus from maternal immunity, but that the postpartum period carries a high relapse risk as those mechanisms lift. The remission she had felt during the second trimester was real. It was also temporary. She relapsed at ten weeks postpartum, as her endocrinologist had predicted.</p>
<p><strong>Elijah, 53.</strong> He chose radioiodine ablation after two years on antithyroid drugs — his endocrinologist's preferred option for long-term management. He became hypothyroid within six months of the ablation, which was the expected outcome: the radioiodine destroyed enough thyroid tissue to eliminate the hyperthyroidism, and he then needed levothyroxine for the rest of his life. He had traded one thyroid disease for another, which was the intended result, and was managing well. What he had not been fully prepared for was the permanent nature of that trade. He had assumed "getting rid of" the hyperthyroidism meant being done with thyroid problems. It did not.</p>
<p><strong>Adaeze, 31.</strong> Her Graves' disease presented first as infertility. She and her husband had been trying to conceive for eighteen months when her reproductive endocrinologist ordered a comprehensive hormonal panel and found suppressed TSH and elevated free T4 alongside elevated TSI. Thyrotoxicosis impairs fertility by disrupting the LH surge and disrupting progesterone production in the luteal phase. Her reproductive endocrinologist referred her to an endocrinologist for thyroid control before further fertility treatment. Within four months of achieving euthyroid status on carbimazole, she conceived naturally. The disease that had been blocking her fertility had been invisible in every workup that had not included the thyroid.</p>
''',
})
...
<p><strong>Transcript witness — Dr. Anthony Chaffee podcast.</strong> A speaker describing her daughter's psoriasis remission: "My oldest daughter has severe psoriasis and was on biologics. You can't tell your kids anything, really. But she is off the medication. She is not fully carnivore, but she is on a strict ketogenic diet and weight training, and she has been off her biologics for nine months. Biologics are dangerous drugs — serious side effects, serious long-term risks. The idea that a dietary change could get someone off them, without a drug company funding the trial, means no one is studying it properly. We are living the study."</p>
<p><strong>Transcript witness — zerocarb community.</strong> Wendy, medical herbalist: "I have had chronic scalp psoriasis for years. After trying broccoli — I had been 99% carnivore for two years — I started itching my scalp again. I thought, 'Wow, I had not had that. I had not noticed it gone until it came back.' That is how you discover something is a trigger. You only see the absence when you reintroduce. The carnivore community is full of people who discovered this the same way: something came back, and then they knew."</p>
<p><strong>Callum, 44.</strong> His psoriasis had covered thirty percent of his body surface area at its peak and he had been through methotrexate, acitretin, and two biologics. He had not been told, in ten years of dermatology appointments, that there was any meaningful dietary approach worth considering. He found a carnivore community online, tried it for ninety days, and experienced the most significant skin clearance of his adult life. He went back to his dermatologist with photographs. His dermatologist said it was probably a spontaneous remission. He asked whether it was possible the diet had caused it. His dermatologist said: "I couldn't say either way." Callum stopped the diet. The plaques returned within three weeks. He went back to the diet. His dermatologist had no comment.</p>
<p><strong>Nora, 19.</strong> Her guttate psoriasis appeared two weeks after a strep throat infection — hundreds of small teardrop spots covering her trunk, back, and upper arms almost overnight. Her GP identified it immediately and told her that guttate psoriasis following strep infection was a well-recognised pattern. What her GP also told her was that most guttate episodes resolve within three to four months. Hers did not. At six months it had evolved into plaque psoriasis. Her GP referred her to dermatology. The infection had been the trigger. The genetic susceptibility had been there all along. The infection had just unlocked something that could not be fully closed again.</p>
<p><strong>Theo, 56.</strong> He had psoriasis for thirty-one years and had accepted it as a chronic condition he managed rather than one he could change. What shifted his thinking was a cardiac event — a heart attack at 54 — that his cardiologist attributed partly to the chronic systemic inflammation of longstanding psoriasis. He had not known that psoriasis significantly elevated cardiovascular risk independent of traditional risk factors. He had been treating his skin. His cardiologist was treating his arteries. Nobody had explained to him that the same inflammatory process was doing damage in both places simultaneously.</p>
''',
})
...
<p><strong>Transcript witness — Dr. Anthony Chaffee podcast.</strong> On the diagnostic precision of celiac disease: "Celiac is called an autoimmune disease, but it is actually the clearest demonstration that so-called autoimmune diseases are not the immune system attacking itself at random — they are the immune system responding to a specific antigen that should not be present. Remove the antigen, the immune response stops. The tissue heals. The antibodies normalise. This is not mysterious. It is antigen removal. The only reason we do not apply this logic to all autoimmune conditions is that we have not identified the specific antigens in most of them. Celiac shows us the model. The question is whether the same model applies elsewhere."</p>
<p><strong>Lena, 12 — her mother Katrin, 38, speaking.</strong> "Lena had been small and tired for years and we had attributed it to her constitution. She was a quiet child and a light eater. It was only when her teacher mentioned that she seemed to be struggling with concentration — more than the other children — that we took it seriously. Her paediatrician ordered bloods and found her anti-tTG at 180. The biopsy showed Marsh grade 3b villous atrophy. She had been absorbing almost nothing from her meals for years. Within six months of removing gluten, her teacher was asking if we had changed her medication — she thought Lena was on a new ADHD drug. She was not on any drug. She was just finally nourished."</p>
<p><strong>Jorge, 67.</strong> He was diagnosed with celiac disease at 67, having had gut symptoms attributed to IBS for over two decades. The diagnosis came when his internist ordered an ANA panel for unrelated joint pain and noticed, while reviewing his chart, that his iron had been persistently low for fifteen years with no documented investigation. The gastroenterology referral found total villous atrophy. He had lived without a diagnosis for more than twenty years — a period during which his bones had been demineralised, his iron stores had been chronically depleted, and a correct explanation for his gut symptoms had existed and been missed.</p>
<p><strong>Astrid, 24.</strong> She tested negative for celiac antibodies twice and was told she did not have celiac disease. She did not find out about the IgA deficiency until three years later, when a haematologist, investigating something else, noted that her total IgA was undetectable. Celiac antibody testing relies on IgA; in IgA-deficient patients, the standard test produces a false negative. A repeat biopsy — done because she was IgA-deficient and symptomatic — showed partial villous atrophy. She had been given clear reassurance, twice, that she did not have a condition she had. The test had failed her, not her symptoms.</p>
''',
})
...
<p><strong>Moira, 58.</strong> She had been managing Sjögren's for twelve years when she started to lose teeth — not from decay but from the root surfaces fracturing without warning, the result of a decade of xerostomia that had stripped away the protective salivary environment teeth require. Artificial saliva, sugar-free gum, fluoride varnish, scrupulous oral hygiene: she had done everything her dentist recommended. The disease had done more damage faster. She had three implants, bridgework, and a dentist she saw every three months who had become, inadvertently, her most consistent monitor of disease activity.</p>
<p><strong>Yolanda, 46.</strong> Her anti-Ro/SSA antibodies had been present on two ANA panels in her thirties, reported by two different GPs as "weakly positive, unlikely to be significant." No one had investigated further. She was 46 when her rheumatologist — reviewing all her blood results at her first appointment — saw the two old positives alongside her current dry eyes and dry mouth and lip biopsy showing 62 lymphocytes per duct. The anti-Ro had been significant for twelve years. The diagnosis had been present in her blood all that time, waiting for someone to read it.</p>
<p><strong>Cyrus, 39.</strong> He had primary Sjögren's and peripheral neuropathy that his neurologist initially attributed to idiopathic small-fibre neuropathy. The burning pain in his feet was constant from midday onward and woke him at night. He was treated with pregabalin and duloxetine. It was only when he was referred to a specialist Sjögren's clinic — for unrelated monitoring — that the neurologist there noted that small-fibre neuropathy in Sjögren's is driven by anti-Ro antibody deposition in the dorsal root ganglia. His neuropathy was not idiopathic. It was directly caused by his autoimmune condition. The appropriate treatment targeted the underlying disease, not just the pain signal.</p>
<p><strong>Transcript witness — Dr. Anthony Chaffee podcast.</strong> On the shared upstream mechanism across autoimmune conditions: "The same intestinal permeability that drives lupus, RA, and MS is the upstream driver in Sjögren's. The anti-Ro and anti-La antibodies target RNA-binding proteins that become exposed at the surface of apoptotic cells — exactly the kind of cellular debris that floods the systemic circulation when the gut barrier fails. Patients with Sjögren's who address intestinal permeability report improvements in systemic symptoms before the gland-specific symptoms improve — which tells you something about the sequence of events that produces the disease in the first place."</p>
''',
})
...
<p><strong>Transcript witness — zerocarb community.</strong> A woman who moved to Germany and developed AS: "About 30 years ago I moved to Germany and got into the culture — cake every day, breaded schnitzel, German beer. My wheat uptake went up significantly. Before I knew it I had a myriad of illnesses. The first autoimmune diagnosis was ankylosing spondylitis. With me it came out in my eyes — I kept having inflammation of the iris. They tested me and found I was HLA-B27 positive. The connection between the wheat, the gut, and the spine took me years to make, because nobody made it for me."</p>
<p><strong>Transcript witness — zerocarb community.</strong> A man with AS reflecting on carnivore: "I have been diagnosed with ankylosing spondylitis. They call it bamboo spine. I have always thought I was really stiff — I always worked out and pushed through it. Since going carnivore, the stiffness is different. I do not know how to explain it except that it is less constant. The eczema I also have has stabilised. The AS and the eczema and the ADHD — I always thought these were separate things. I am not so sure anymore."</p>
<p><strong>Omar, 31.</strong> He was HLA-B27 positive from a test ordered after his older brother was diagnosed with AS. He had no symptoms at the time. For three years he monitored, knowing the risk. The sacroiliac pain arrived when he was 30, six months after he had gained significant weight and changed jobs to a desk-based role. His rheumatologist started a NSAID and explained that the disease might have been triggered by the change in activity level and the weight gain, which increased mechanical load at the entheses. The genetics had been there all along. The trigger had waited for the right conditions.</p>
<p><strong>Francesca, 38.</strong> Her AS responded well to a TNF-alpha inhibitor and she had been in clinical remission for four years when she decided to try pregnancy. Biologics carry fetal risks and are typically stopped in the second trimester; her rheumatologist and obstetrician co-managed the switch to sulfasalazine, which is safer in pregnancy but less effective. She flared at 28 weeks. The flare was managed with short-course corticosteroids. Her baby was healthy. The postpartum period brought a further flare as immune tolerance mechanisms lifted. She restarted her biologic at eight weeks postpartum. Managing AS through pregnancy required more medicine, more monitoring, and more decisions than she had anticipated when she first read that the disease was "compatible with normal life."</p>
<p><strong>Dev, 43.</strong> His bamboo spine on plain X-ray was discovered incidentally during a chest X-ray for an unrelated respiratory matter. He had not been diagnosed with AS. He had been stiff, he had had back pain for years, and he had managed both with ibuprofen and a physiotherapist who told him his core was weak. The radiologist's report used the words "advanced ankylosing spondylitis with bridging syndesmophytes at all lumbar levels." He brought the report to his GP, who referred him to rheumatology. He was told that his disease was too advanced for the biologics that might have slowed it in earlier stages to make a significant structural difference. The X-ray had found the final chapter of a story nobody had been watching.</p>
''',
})
...
<p><strong>Transcript witness — metabolicmind podcast.</strong> Mary, describing her experience with MG and ketogenic diet: "I started having symptoms again of my illness. I had been diagnosed with myasthenia gravis and I was actually using a wheelchair for quite a few years back in 2012. I started to feel like I was getting sick again and so I started looking for new dietary changes to make. I found out about the ketogenic diet, started the protocol, and I started to improve. I have not returned to the wheelchair. I want other people with MG to know that I looked, and I found something, and it worked."</p>
<p><strong>Clem, 66.</strong> His thymectomy had been successful in removing the thymoma, and his neurologist had told him that anti-AChR titres typically decline after thymectomy — sometimes slowly, sometimes dramatically. His titres declined slowly. Eighteen months after surgery, his MG was better but not gone. He was still on pyridostigmine and had added prednisolone for the months when the disease was most active. His neurologist told him that some patients achieve complete stable remission after thymectomy and some do not; the thymus generates the disease, but the B cell memory that maintains it can persist independently. He was in the second category, learning to be patient with an outcome that was better, but not finished.</p>
<p><strong>Ingrid, 37.</strong> She managed her MG through two pregnancies — a process her neurologist described as "high-risk but manageable." MG can worsen or improve unpredictably in pregnancy; her first pregnancy improved her disease, her second worsened it. Her second baby was born with neonatal MG — a transient condition in which maternal anti-AChR antibodies cross the placenta and cause temporary muscle weakness in the newborn. Her baby required respiratory support for eight days in the NICU before the antibodies cleared and strength returned. Her neurologist had warned her this could happen; the warning had not made those eight days easier.</p>
<p><strong>Transcript witness — Dr. Anthony Chaffee podcast.</strong> On the thymic origin of MG and dietary modulation: "Myasthenia gravis is one of the most mechanistically clear autoimmune conditions — the thymus generates the B cells that produce AChR antibodies, and thymectomy is the only intervention that addresses the source. But the gut-thymus axis is real: the same systemic immune activation that primes autoreactive B cells in other autoimmune conditions operates here too. Reducing the systemic inflammatory load through diet reduces the peripheral activation that maintains AChR-directed antibody production. It does not replace thymectomy. But it may shift the trajectory."</p>
<p><strong>Lola, 22.</strong> She developed MG as a complication of checkpoint inhibitor therapy — the immunotherapy she was receiving for a stage 3 melanoma. Her oncologist had warned her of the risk of immune-related adverse events; MG was one of the rarer ones, occurring in under 1% of patients on her drug. When her eyelid drooping and swallowing difficulty began at week 8 of treatment, the oncology team stopped the immunotherapy and started her on corticosteroids. Her MG resolved over six weeks. Her melanoma remained in remission. She had developed, treated, and recovered from an autoimmune disease in the space of two months as a side effect of cancer treatment. The experience changed how she understood both diseases.</p>
''',
})
