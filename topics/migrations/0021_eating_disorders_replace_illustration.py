...
NEW_FIGURE = (
    ...
    '<img src="/static/blog/illustrations/eating-disorders-reward-circuit.png" '
    'alt="Anorexia & Eating Disorders: Hypothalamic Reward Disruption — normal, disruption, metabolic intervention" '
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('topics', '0020_shadow_replace_illustration'),
    ]
